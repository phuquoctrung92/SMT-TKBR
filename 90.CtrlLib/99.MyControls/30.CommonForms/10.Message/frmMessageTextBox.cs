...
namespace CtrlLib.Message
{
    ...
    /// <summary>
    /// カスタムメッセージボックス(テキストボックス付き)
    /// </summary>
    public partial class frmMessageTextBox
    {
        ...
        public frmMessageTextBox(string _inputText ,int textMaxLength = 50)
        {
            // この呼び出しは、Windows フォーム デザイナで必要です。
            InitializeComponent();

            txtInputData.MaxLength = textMaxLength;
            txtInputData.Text = _inputText;
        }
